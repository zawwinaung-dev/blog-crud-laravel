    ...
    <div class="container" style="600px">
        ...
        <div class="card mb-2">
            <div class="card-body">
                ...
                <div class="text-muted mb-2">{{ $article->created_at->diffForHumans()}}</div>
                @can('delete-article', $article)
                    <a href="{{ url("/articles/edit/$article->id") }}" class="btn btn-sm btn-outline-success">Edit</a>
        ...
        @auth
            <form action="{{url("/comments/add")}}" method="POST">
                ...
                <textarea name="content" class="form-control my-2" placeholder="Content"></textarea>
